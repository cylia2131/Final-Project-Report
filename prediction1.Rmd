...
Summary of the results: - Decision tree model - is the worst model running, has the low mean and the highest standard deviation. -Random Fores model - has the highest mean accuracy and lowest standard deviation
...
This two models preforms as expected, the deviation from the cross validation accuracy is low and I do not see a reason to change resampling method or adding repetitons.
...
- The best tuning parameters hads 150 trees (boosting iterations),  interaction depth 3, shrinkage 0.1.



###Making prediction on the 20 data pointsusing random forest

Decision Tree Model: 74.58 %, Random Forest Model: 99.86 %
